...
| `V_CRUISE` | 15000 | ALIGN/NON_ALIGN 직진 듀티 |
| `V_SEEK` | 10000 | SEEK 직진 듀티 |
...
| `PIVOT_SUBSTEPS_90_L` | 27 | 90° 좌회전 마이크로 피벗 횟수 (캘리브 2026-05-27 v2) |
| `PIVOT_SUBSTEPS_90_R` | 24 | 90° 우회전 마이크로 피벗 횟수 (캘리브 2026-05-27 v2) |
